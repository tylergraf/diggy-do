...
exports.newTransaction = function(req, res, next) {
  ...
  var newTransaction = new Transaction({_user: transaction._kid._user, date: transaction.date, _kid: transaction._kid._id, _task: transaction._task, approved: transaction.approved});
